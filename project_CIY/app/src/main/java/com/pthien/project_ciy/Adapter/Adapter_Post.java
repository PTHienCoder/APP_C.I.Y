...
//      String timeStamp = String.valueOf(System.currentTimeMillis());
    ...
    private void sendcmnt(Myholder myholder, String pid, String value, String uid){
        String timeStamp = String.valueOf(System.currentTimeMillis());
        ...
        hashMap2.put("idnoti",timeStamp);
        hashMap2.put("idp", pid);
        hashMap2.put("timeNoti", timeStamp);
        hashMap2.put("content", value);
        hashMap2.put("uid", myUid);
        hashMap2.put("uname", myname_cmt);
        hashMap2.put("uimg", myimage_cmt);
        user.child(uid).child("Notification").child(timeStamp).setValue(hashMap2);
