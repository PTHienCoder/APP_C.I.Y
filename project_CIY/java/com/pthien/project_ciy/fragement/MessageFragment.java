...
import com.pthien.project_ciy.Adapter.Adapter_user_chat;
...
public class MessageFragment extends Fragment {
    RecyclerView rcv_user_chat;

    Adapter_user_chat adapter_user;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcv_user_chat = view.findViewById(R.id.rcv_user_chat);
        rcv_user_chat.setHasFixedSize(true);
        rcv_user_chat.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    adapter_user = new Adapter_user_chat(getActivity(), userList);
                    adapter_user.notifyDataSetChanged();
                    rcv_user_chat.setAdapter(adapter_user);
